...
const ElemStreetView = ({ streetViewLocation, setStreetViewLocation }) => {
    ...
    useEffect(() => {
        ...
        // Guard StrictMode: cleanup cancela este timeout antes do panorama ser criado
        timeoutRef.current = setTimeout(() => {
            ...
            // Fecha se não houver cobertura Street View nessa localização
            ...
            // Failsafe: se tiles não carregarem em 4s (ex: 429), fecha o overlay
            failsafeRef.current = setTimeout(() => {
                if (!tilesLoaded) setStreetViewLocation(null);
            }, 4000);

            // Inicia rotação só depois que os tiles carregarem (evita tela preta)
